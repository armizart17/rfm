...
metrics3dof.nrmse2  = metrics3dof.rmse2 / mean(BSC_3dof); 
...
% Add a textbox to display RMSE (3DoF) DECIMAL
gof_text_3dof = ['\bfRMSE (3DoF) = ', num2str(metrics3dof.rmse, '%.4f')];
...
% Add a textbox to display RMSE (2DoF) DECIMAL NOTATION
gof_text_2dof = ['\bfRMSE (2DoF) = ', num2str(metrics2dof.rmse, '%-.2E')];
...
% title_figures = ['P',num2str( numPhantomSam ), '_fig'];
