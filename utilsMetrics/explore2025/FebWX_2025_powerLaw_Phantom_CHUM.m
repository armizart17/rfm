...
if numPhantomSam == 20 % P20 ACS = 0.6851 dB/cm/MHz
    ...
    % alpha_sam   = 0.70; % [dB/cm/MHz]
    alpha_sam   = 0.551509191332541; % [dB/cm/MHz]
...
elseif numPhantomRef == 22 % P22 ACS = 0.3007 dB/cm/MHz
    ...
    % alpha_ref   = 0.31; % [dB/cm/MHz]
    alpha_ref   = 0.222127445307033; % [dB/cm/MHz]
...
elseif numPhantomSam == 22 % P22 ACS = 0.3007 dB/cm/MHz
    b_sam       = 5.125957E-07;
    n_sam       = 3.670544;
    alpha_sam   = 0.222127445307033; % [dB/cm/MHz]
end
...
if numPhantomRef == 20 % P20 ACS = 0.6851 dB/cm/MHz    
    b_ref       = 5.705978E-06;
    n_ref       = 3.864606;       
    alpha_ref   = 0.551509191332541; % [dB/cm/MHz]
...
comp_freq_a = comp_mod_freq_a(alpha_ref,j_sam,j_ref,band,depth,q);
% comp_freq_a = comp_mod_freq_a(alpha_ref,1,1,band,depth,q);
...
if (methodsRegu)  ylim([0 0.8]); %yticks([0:0.01:0.05])
else              ylim([-15 15])
end
title('\Deltan');
ylabel('\Deltan [a.u.]');
