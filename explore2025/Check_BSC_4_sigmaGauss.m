...
%%% TEST FAST GAUSS SIMULATIONS DIFFERENT SIGMAS 
% OF GAUSS KERNEL
...
folderDataSam = sprintf('Gauss%.3g_a%.1f_pow%.1f', sigmaValue, alpha_sam, j_sam);
...
folderDataRef = sprintf('Gauss%.3g_a%.1f_pow%.1f', sigmaValue, alpha_ref, j_ref);
