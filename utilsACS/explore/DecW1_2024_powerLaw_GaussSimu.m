...
% TEST 2DoF with priors and 3DoF by changing estim_method
% Dec 2024 EMZ
...
estim_method = '2DoF-a';
% estim_method = '2DoF-g'; % TBD
% estim_method = '2DoF-s'; % TBF
...
% SAM = load(fullfile(pathData, 'simGauss_ACstyle\rf_gauss1.matw'));
...
delta_alpha_the = alpha_sam - alpha_ref; % [dB/cm/MHz]
...
j_ref = 1;
comp_ref    = comp_ref_a(delta_alpha_the,j_ref,band,depth,q);
...
alpha_ratio = delta_alpha_the*ones(p, q);
