...
%     delta_n         = 1.1;
% 
% elseif numPhantomRef == 20  % P20 ACS = 0.6851 dB/cm/MHz
%     refPhan_alpha   = 0.6851; % [dB/cm/MHz]
%     delta_n         = -1.1;
% end
...
% par_rpl.sigma   = [1.44, 1.44, 1.44, 1.44]; % sigma_fid, sigma_b, sigma_n, sigma_a  hector
...
if strcmp(reguType, 'high')
    ...
    mu_rpl_tv    = [1E5; 1E5; 1E5]; % [mu_b, mu_n, mu_a] % Test hyperregu
...
% n_ratio     = delta_n*ones(size(b_ratio)); % 2dofn
