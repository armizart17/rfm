...
%% COMPENSATE GAUSS ATTEMPT 2DoF-a
...
%% COMPENSATE GAUSS ATTEMPT 2DoF-s
...
%% COMPENSATE GAUSS ATTEMPT 2DoF-g
...
nameBSC = strcat('BSC_', rf_sam_name);
% BSC = calculateBSC_RPM_ok(SAM, REF, pars); % only once
% save(fullfile(pathData, 'simTUFFC', nameBSC), "BSC")
load(fullfile(pathData, 'simTUFFC', nameBSC));
freq = BSC.band;
