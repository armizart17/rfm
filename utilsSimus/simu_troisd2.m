...
% inspired by % Modelling A Focused Bowl Transducer Assuming Axisymmetry Example
% location C:\Users\emirandaz\AppData\Roaming\MathWorks\MATLAB
% Add-Ons\Collections\k-Wave\example_at_focused_bowl_A
...
for iRef = 1:4
    for iPos = 1:4
        ...
        % move the array
        translation(2) = yPositionArray(iPos);
        yElem = yElem + yPositionArray(iPos);
        ...
        input_args = {...
            ...
            'PlotPML', false, ...
            'DisplayMask', 'off', ...
            'RecordMovie', true, 'MovieName', char("movie_"+iPos)};
        ...
        save("rf_prebf_ref"+iRef+"_pos"+iPos+".mat",...
