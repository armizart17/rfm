...
% srun matlab -nosplash -nodesktop -nodisplay -r "cd('./codes'); simuPowLaw_TUFFC25($matlab_args); exit;"
...
clearvars -except iSim alpha_value numSim nameFolderOut list_rho_mean list_rho_std OutputDir
clc; rng shuffle;
